...
1. **Root Access Restriction:** Root password login was explicitly prohibited during the `setup-alpine` phase to prevent basic vector attacks.
   <br>![Init](init.png)
   <br>![Blocking Root](blocking-root.png)
...
2. **Secure Privilege Escalation:**
   ...
   <br>![Privilege Escalation](privilege%20escalation%20setup%20%28Doas%29.png)
...
3. **SSH Hardening & Key Verification:**
   ...
   <br>![SSH Hardening](SSH%20Hardening.png)
   <br>![Fingerprint](fingerprint.png)
...
<br>![Fastfetch](fastfetch.png)
<br>![Firewall](firewall-iptables.png)
...
<br>![First Interaction](first%20interaction.png)
<br>![Final File Read](windows-to-linux%28final.png)
